...
export const additionalMeasurementsQuery =
    // eslint-disable-next-line quotes
    "coalesce((SELECT json_object_agg(measurement_name, grams) FROM recipes.ingredient_measurement AS i_m WHERE i.ingredient_id = i_m.ingredient_id), '[]'::json) AS additional_measurements";
